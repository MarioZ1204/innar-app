...
function buildIndexHandler(publicDir, appVersion) {
  return function indexHandler(req, res) {
    ...
    html = html
      ...
      .replace('</head>', `<script>window.APP_VERSION="${appVersion}";window.INNAR_SOCKET_BASE=Object.assign({path:"/socket.io/",transports:["polling","websocket"],withCredentials:!0,upgrade:!0,rememberUpgrade:!0},typeof window.INNAR_SOCKET_BASE==="object"&&window.INNAR_SOCKET_BASE!==null&&window.INNAR_SOCKET_BASE||{});</script>\n</head>`);
